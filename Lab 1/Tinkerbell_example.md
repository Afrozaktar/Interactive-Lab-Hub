...
> aim for this much thought. (We use Tinker Bell here because it's the lab's
> touchstone; you won't find it in the hat.)

**COLLABORATORS:** Jane Doe, John Roe

**THE MASTERWORK YOU DREW FROM THE HAT:** Tinker Bell's light — the original 1904
stage production of *Peter Pan* (J. M. Barrie).

---

## Part 0. Know Your Master

In the first stage production of *Peter Pan*, Tinker Bell was not played by an
actor. She was a bright circle of light, thrown by an off-stage operator who
reflected a powerful lamp off a small handheld mirror, darting the spot around
the set. Her "voice" was a tinkling chime (originally a collar of bells). Every
bit of her character — her mischief, her devotion to Peter, her jealousy of
Wendy — had to be produced by *how the light moved and how the other actors
responded to it.*

The core interaction: **a point of light behaves like a living creature, and the
people on stage treat it as one, which is what makes the audience believe it is
one.** The light has a small but legible vocabulary:

- **Brightness** reads as life and mood — bright and quick when she's happy or
  alive; dim and slow when she's hurt or fading.
- **Motion** reads as attention — she darts to whatever she wants Peter to notice,
  and flits angrily around Wendy.
- **A flare** reads as strong emotion — a hot surge when she's jealous or furious.
- **Blink + chime** reads as speech — a rhythm the other characters "translate"
  aloud for the audience ("She says you're a silly ass, Peter").

Its most famous moment is a genuine input/output loop with the *audience*: Tink
drinks the poison meant for Peter, her light sinks toward darkness, and Peter
turns to the house and asks everyone to clap if they believe in fairies. The
audience's applause is the input; the light rising back to full is the output.

**Strengths:** astonishing economy — a whole beloved character from one moving
light and some acting. It offloads imagination onto the audience, and it makes
them *complicit* (they save her). **Weaknesses:** it depends completely on a
skilled hidden operator and on the other actors' reactions; alone, the light
means nothing. It's also fragile — miss the timing and the illusion collapses.

## Part A. Plan

**Setting:** The Darling children's nursery at night, and then Neverland. Ours is
staged as the nursery — a dark room, one window, beds.

**Players:** Peter Pan; Wendy; **Tinker Bell (the light)**; a hidden **wizard**
operating the light; and — crucially — the **audience**, who become players in
the revival beat.

**Activity:** Peter talks to and about Tink; Tink answers only in light and chime;
Peter translates her for us. She leads him, sulks, flares with jealousy, and
finally fades and is revived.

**Goals:** Peter wants Tink's help and wants us to save her. Tink wants Peter's
attention (and Wendy gone). The wizard wants the light to feel alive and perfectly
on-cue. The audience, by the end, wants to keep her alive.

**Our seven storyboards** (photographed and pasted in above this line in a real
submission):
